          ...
          <div className="app-menu-wrapper" ref={ref}>
            ...
            {showMenu && (
              <div className="app-menu-dropdown">
                <div className="dropdown-item" onClick={() => setTheme(settings.theme === 'dark-cyber' ? 'light-sky' : 'dark-cyber')} role="button" tabIndex={0}>
                ...
                <div className="dropdown-item" onClick={() => handleMenuItemClick('devtools')} role="button" tabIndex={0}>
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" className="w-5 h-5">
