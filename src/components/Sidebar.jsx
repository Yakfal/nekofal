...
const makeChannelsSection = (withAdult) => ({
  ...
  items: [
    ...
    { path: '/iptv', label: 'Live Channels', icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
    ...
    { path: '/cinema', label: 'Free Movies', icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
        <rect x="2" y="4" width="20" height="16" rx="2" strokeWidth="2"/>
        <path d="M7 4v16M17 4v16M2 9h5M2 15h5M17 9h5M17 15h5" strokeWidth="2" strokeLinecap="round"/>
      </svg>
    )},
  ]
});
...
const Sidebar = ({ isCollapsed, toggleSidebar, width }) => {
  ...
  const sections = [
  {
    ...
    items: [
      ...
      { path: '/playlists', label: 'My Mixes & Saved', icon: (
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
